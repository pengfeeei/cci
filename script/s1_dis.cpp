...
//        cout<<"read in ident "<<j<<endl;
	...
	j=0;
        ...
        infile.close();infile.clear();
        gene_num=j;
//        cout<<"read in gene "<<gene_num<<endl;
...
//        cout<<"cal expression difference ... "<<endl;
	...
	//	cout<<"ref "<<j+1<<endl;
          ...
          //      cout<<"valid dis pairs "<<count_all<<endl;



       		outfilename="temp_out/s1_distri_"+samplestr+"_"+myfunc.IntToString(j+1)+".txt"; 
        ...
        cout<<"cal expression difference ... done."<<endl;

	outfilename="temp_out/s1_"+samplestr+".txt";
        outfile.open(&outfilename[0],ios::out);
        for(j=0;j<ident_ref_num;j++)
        {
